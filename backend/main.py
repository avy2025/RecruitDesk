...
async def load_models():
    ...
    if EMBED_CACHE_DIR.exists() and any(EMBED_CACHE_DIR.iterdir()):
        logger.warning("⚠️ WARNING: Existing embeddings found in .embed_cache/. If these were generated by the previous model (all-mpnet-base-v2), they are INCOMPATIBLE and will cause incorrect matching. Please delete the .embed_cache/ directory manually before first run.")
    ...
    try:
        ...
        logger.warning("Falling back to paraphrase-MiniLM-L3-v2")
